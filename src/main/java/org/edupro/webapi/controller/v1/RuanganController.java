...
public class RuanganController extends BaseController<RuanganRes> {
    ...
    @PostMapping
    private ResponseEntity<Response> save(@RequestBody @Valid RuanganReq request){
        var result = service.save(request);
        return getResponse(result);
    }

    @PutMapping("/{id}")
    private ResponseEntity<Response> update(@RequestBody @Valid RuanganReq request,
