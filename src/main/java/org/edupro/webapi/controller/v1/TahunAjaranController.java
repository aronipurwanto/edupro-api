...
public class TahunAjaranController extends BaseController<TahunAjaranRes> {
    ...
    @PostMapping
    private ResponseEntity<Response> save(@RequestBody @Valid TahunAjaranReq request){
        var result = service.save(request);
        return getResponse(result);
    }

    @PutMapping("/{id}")
    private ResponseEntity<Response> update(@RequestBody @Valid TahunAjaranReq request,
