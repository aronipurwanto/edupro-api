...
@AttributeOverrides({
	@AttributeOverride(name = "id", column = @Column(name="RUANGID")),
...
public class RuanganEntity extends BaseIdEntity {
	...
	@ManyToOne
	@JoinColumn(name = "GDID", insertable = false, updatable = false)
